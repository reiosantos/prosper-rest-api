    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('provider', models.ForeignKey(db_column='oauth_provider_id', on_delete=django.db.models.deletion.CASCADE, related_name='venue_tokens', to='oauth.OAuthProvider')),
                ('venue', models.ForeignKey(db_column='psp_venue_id', on_delete=django.db.models.deletion.CASCADE, to='venue.Venue')),
            ],
            options={
