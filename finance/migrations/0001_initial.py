    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('loan', models.ForeignKey(default=home.support.support_functions.get_id, help_text='loan being repayed', on_delete=django.db.models.deletion.SET_DEFAULT, to='finance.Loan')),
            ],
            options={
                'default_permissions': ('add', 'delete', 'modify', 'view'),
            },
